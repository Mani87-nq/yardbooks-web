...
// Generic product type that extends SearchableProduct
type ProductWithExtras = SearchableProduct & Record<string, unknown>;
 ...
 * - Touch-friendly
 * 
 * So easy an 8-year-old can use it!
 */
    ...
    <div className={cn("relative", className)}>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 text-sm text-gray-500">
                  ...
                  <span>•</span>
                  <span className={cn(
                    result.product.quantity <= 5 ? "text-red-600 font-medium" : ""
                  )}>
              ...
              <div className="text-right flex-shrink-0">
                <div className="text-lg font-bold text-orange-600">
                  {safeFormatJMD(result.product.unitPrice)}
                </div>
                {result.product.category && (
                  <div className="text-xs text-gray-400">{result.product.category}</div>
                )}
              </div>
            </button>
          ))}
      ...
      {isOpen && query && results.length === 0 && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-lg 
                        border border-gray-200 p-8 z-50 text-center">
