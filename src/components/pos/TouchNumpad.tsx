  ...
  return (
    <div className={cn("grid grid-cols-4 gap-2", className)}>
      ...
      <button
        ...
        className={cn(buttonClass, "bg-gray-100 hover:bg-gray-200 text-gray-800")}
      >
        7
      </button>
      <button
      ...
      <button
        ...
        className={cn(buttonClass, "bg-orange-100 hover:bg-orange-200 text-orange-700")}
      >
      ...
      <button
        type="button"
        onClick={handleClear}
        className={cn(buttonClass, "bg-red-100 hover:bg-red-200 text-red-700")}
      >
        C
      </button>
      ...
      <button
        type="button"
        onClick={onSubmit}
        className={cn(buttonClass, "bg-emerald-500 hover:bg-emerald-600 text-white row-span-2")}
        style={{ height: '136px' }}
      >
      ...
      <button
        ...
        className={cn(buttonClass, "bg-gray-100 hover:bg-gray-200 text-gray-800 col-span-2")}
      >
        0
      </button>
      {allowDecimal && (
