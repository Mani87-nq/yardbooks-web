    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{account.accountName}</h1>
              <p className="text-gray-500 dark:text-gray-400">{account.bankName} • ****{account.accountNumber.slice(-4)}</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-gray-900/20 border border-gray-200 dark:border-gray-700 p-6">
          ...
          <p className="text-3xl font-bold text-gray-900 dark:text-white">{formatCurrency(account.currentBalance)}</p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-gray-900/20 border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-gray-900/20 border border-gray-200 dark:border-gray-700 p-6">
          ...
          <p className="text-xl font-semibold text-gray-900 dark:text-white capitalize">{account.accountType}</p>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
          <div className="text-gray-600 dark:text-gray-400 text-sm mb-1">Unreconciled</div>
