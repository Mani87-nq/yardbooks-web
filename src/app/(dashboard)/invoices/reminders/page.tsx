    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">Track and send payment reminders for overdue invoices</p>
        </div>
        ...
        <Card>
          <div className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Reminders Sent This Month</p>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      autoRemindersEnabled ? 'bg-emerald-600' : 'bg-gray-300 dark:bg-gray-600'
                    }`}
                  >
                    <span
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Schedule */}
              <div>
                <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Reminder Schedule</h4>
                  ...
                  {reminderSchedule.map((item, index) => (
                    <div
                      ...
                      className={`flex items-center justify-between p-3 rounded-lg border ${
                        item.enabled ? 'border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-900/30' : 'border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900'
                      }`}
                    >
                      <div className="flex items-center gap-3">
                        <button
                          ...
                          className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors ${
                            item.enabled ? 'bg-emerald-600' : 'bg-gray-300 dark:bg-gray-600'
                          }`}
                        >
                          <span
              ...
              <div>
                <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Email Template Preview</h4>
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                  <div className="bg-gray-100 dark:bg-gray-700 px-4 py-2 border-b border-gray-200 dark:border-gray-700">
                    <p className="text-xs text-gray-500 dark:text-gray-400">Subject: Payment Reminder - Invoice #INV-XXXX</p>
                  </div>
                  <div className="p-4 text-sm text-gray-700 dark:text-gray-300 space-y-3 bg-white dark:bg-gray-800">
      ...
      <Card padding="none">
        <div className="p-6 border-b border-gray-100 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Overdue Invoices</h3>
          ...
          <div className="divide-y divide-gray-100 dark:divide-gray-700">
            {sortedOverdueInvoices.map((invoice) => {
              ...
              return (
                <div
                  key={invoice.id}
                  className={`p-4 sm:p-6 ${styles.border} hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors`}
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-gray-500 dark:text-gray-400">
                        <span className="font-medium text-gray-700 dark:text-gray-300">{invoice.invoiceNumber}</span>
            ...
            {activityLog.length === 0 ? (
              ...
              <div className="space-y-3">
                {activityLog.slice(0, 10).map((entry) => (
                  <div
                    key={entry.id}
                    className="flex items-start gap-3 py-2 border-b border-gray-50 dark:border-gray-700 last:border-b-0"
                  >
                    {/* Icon */}
                    <div
