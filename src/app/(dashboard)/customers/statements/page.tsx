            ...
            <div className="flex-1 relative">
              ...
              <div className="relative">
                <button
                  ...
                  className="w-full flex items-center justify-between rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-left focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500"
                >
                  <span
                    className={
                      selectedCustomer ? 'text-gray-900' : 'text-gray-400'
                    }
                  >
                    {selectedCustomer
        ...
        <div className="space-y-4">
          ...
          <Card padding="none">
            <div className="p-6">
              ...
              {/* Opening Balance */}
              <div className="flex justify-between items-center py-3 px-4 bg-gray-100 rounded-t-lg border border-gray-200">
              ...
              {/* Closing Balance */}
              <div className="flex justify-between items-center py-3 px-4 bg-emerald-50 rounded-b-lg border border-emerald-200">
