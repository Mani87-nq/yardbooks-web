            ...
            {PLANS.map((plan) => (
              <div 
                ...
                className={`bg-white rounded-2xl p-8 border-2 ${
                  plan.id === 'business' 
                    ? 'border-emerald-500 shadow-xl shadow-emerald-500/10 relative' 
                    : 'border-gray-200'
                }`}
              >
                {plan.id === 'business' && (
                ...
                <div className="text-sm text-gray-500 mb-6">
                  {plan.maxUsers === -1 ? 'Unlimited' : plan.maxUsers} user{plan.maxUsers !== 1 ? 's' : ''} • {plan.maxCompanies === -1 ? 'Unlimited' : plan.maxCompanies} {plan.maxCompanies === 1 ? 'company' : 'companies'}
                </div>
